// API Configuration
const API_BASE_URL = "https://primedrive-backend.onrender.com/api";
...
const updateNavigation = () => {
    ...
    if (user) {
        ...
        if (navNotifications) {
            navNotifications.style.display = user.role === 'customer' ? 'block' : 'none';
        }
    } else {
...
const isPublicPage = () => {
    ...
    return publicPages.includes(currentPage) || !currentPage || currentPage === '';
};
